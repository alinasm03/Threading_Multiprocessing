...
#    process6.join()
    ...
    # THREAD
    thread1 = threading.Thread(target=write_to_file, args=(4,))
    thread2 = threading.Thread(target=write_to_file, args=(5,))
    thread3 = threading.Thread(target=write_to_file, args=(6,))
